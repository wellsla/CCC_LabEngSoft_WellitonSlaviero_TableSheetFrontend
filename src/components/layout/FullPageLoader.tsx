...
const D20Spinner = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
...
export function FullPageLoader() {
  return (
    <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-background/80 backdrop-blur-sm animate-in fade-in duration-300">
      <D20Spinner className="text-primary" />
      <p className="mt-4 text-lg font-semibold tracking-wider text-primary">
        Carregando aventura...
      </p>
    </div>
  );
