...
interface RaceTableActionsProps {
  raceId: string;
  raceName: string;
  onActionSuccess: () => void;
}

export function RaceTableActions({
                                   raceId,
                                   raceName,
                                   onActionSuccess,
                                 }: RaceTableActionsProps) {
  ...
  return (
    <>
      <Button asChild variant="ghost" size="icon" className="hover:text-primary">
        <Link href={`/admin/races/${raceId}/edit`}>
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir a raça "{raceName}"?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
